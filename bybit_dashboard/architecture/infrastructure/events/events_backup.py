#!/usr/bin/env python3
"""
📡 EVENTS NEØ - DEFINIÇÕES DE EVENTOS
...
class MarketDataUpdatedEvent(BaseEvent):
    """Evento de dados de mercado atualizados"""
    symbol: str
    price: float
    volume: float
    funding_rate: float
...
@dataclass
class TechnicalIndicatorsUpdatedEvent(BaseEvent):
    """Evento de indicadores técnicos atualizados"""
    symbol: str
    rsi: float
    macd_line: float
    macd_signal: float
...
class NotificationEvent(BaseEvent):
    ...
    title: str
    message: str
    channel: str = "default"  # "telegram", "email", "webhook", "console"
